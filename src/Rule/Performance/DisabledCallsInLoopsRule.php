...
final class DisabledCallsInLoopsRule implements Rule
{
    ...
    public function processNode(Node $node, Scope $scope): array
    {
        ...
        return [
            RuleErrorBuilder::message("Performance: Do not use \"$functionName\" in loop to reassign variable \"$reassignedVariable\".")
                ->identifier('efabrica.disabledCallsInLoops')
                ->tip('See https://www.exakat.io/en/speeding-up-array_merge/')
                ->build(),
        ];
    }
